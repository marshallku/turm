...
/// Minimal socket server matching custerm-linux/src/socket.rs logic
...
/// Minimal dispatch matching custerm-linux/src/socket.rs dispatch()
...
/// Client helper matching custerm-cli/src/client.rs
...
impl TestServer {
    fn new(name: &str) -> Self {
        let socket_path = format!("/tmp/custerm-test-{name}-{}.sock", std::process::id());
